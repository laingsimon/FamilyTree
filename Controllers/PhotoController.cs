...
namespace FamilyTree.Controllers
{
    public class PhotoController : Controller
    {
        ...
        private ActionResult _ProcessPhoto(string size, IFile photoFile)
        {
            ...
            {
                return new StatusContentResult($"Error resizing {photoFile.Name} ({photoFile.Size}): {exc.GetType().Name} - {exc.Message}", "text/plain", HttpStatusCode.InternalServerError);
            }
        }
