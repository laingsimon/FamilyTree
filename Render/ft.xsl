 ...
 <xsl:template match="Tree">
  <html>
   <head>
    ...
    <link type="text/css" rel="stylesheet" href="Render/ft.css" />
    <script type="text/javascript" lanugage="javascript" src="Render/jquery-1.6.4.js"></script>
    <script type="text/javascript" lanugage="javascript" src="Render/ft.js"></script>
   </head>
